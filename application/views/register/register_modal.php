    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body p-3">
                ...
                <div class="card theme-wizard" data-wizard data-controller="#wizard-controller" data-error-modal="#error-modal">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane px-sm-3 px-md-5" id="bootstrap-wizard-tab2">
                                <div class="company_details">
                                    <form class="form-validation" data-options='{"rules":{"confirmPassword":{"equalTo":"#wizard-password"}},"messages":{"confirmPassword":{"equalTo":"<?=$this->lang->line("Register Passwords didn&#39;t match")?>"},"terms":{"required":"You must accept terms and privacy policy"}}}'>
                                        <div class="form-group">
                                ...
                                <div class="private_details hidde">
                                    <form class="form-validation" data-options='{"rules":{"confirmPassword":{"equalTo":"#wizard-password-private"}},"messages":{"confirmPassword":{"equalTo":"<?=$this->lang->line("Register Passwords didn&#39;t match")?>"},"terms":{"required":"You must accept terms and privacy policy"}}}'>
                                        <div class="form-group">
