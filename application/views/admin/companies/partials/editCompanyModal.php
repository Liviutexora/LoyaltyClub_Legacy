    ...
    <div class="modal-content">
        <form action="<?=site_url('edit-company/'.$companyDetails['id'].'')?>" method="post" id="edit-user-form" class="needs-validation" novalidate>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="reference" class="col-sm-6 col-form-label"><?=$this->lang->line('Admin Section Company Label Company Reference')?> <span class="required-sign-label">*</span>: </label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="reference" name="reference" pattern="^[1-9][0-9]*" value="<?=$companyDetails['sponsor_id']?>" required="required">
                    </div>
                </div>
            </div>
