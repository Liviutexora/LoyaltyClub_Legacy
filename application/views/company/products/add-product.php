...
<div class="card mb-3">
    <div class="card-header">
        ...
        <div class="col-6 col-sm-auto d-flex align-items-center pr-0">
            <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><?=$this->lang->line('Company Section Product Label Btn Add Product')?></h5>
        </div>
            ...
            <div class="modal-body">
                    ...
                    */ ?>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <div class="dropzone dropzone-multiple p-0" data-dropzone data-options='{"url":"upload-photos","parallelUploads" : "30","autoProcessQueue" : false, "acceptedFiles" : "image/*"  }'>
                                <div class="fallback">
