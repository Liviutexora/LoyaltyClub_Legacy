    ...
    <div class="modal-content">
        <form action="<?=site_url('add-tickets')?>" method="post" id="add-tickets-form" class="needs-validation" novalidate>
            ...
            <div class="modal-footer">
                    ...
                    <button class="btn btn-success btn-sm" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?=$this->lang->line('Loading Btn Text General')?>" onclick="submit_form('#add-tickets-form', '#save-result')" type="submit"><?=$this->lang->line('Modals Label Btn Save Changes')?>
                    </button>
            </div>
        </form>
    </div>
