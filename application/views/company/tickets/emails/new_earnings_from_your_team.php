                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xxl-6">
                            <div class="card shadow-none email-content-container mb-3 p-3">
                                ...
                                <br><br>
                                <?=$this->lang->line('Company Section Ticket Label Congratulations New Earnings From Your Team')?>
                                <br>
                                <?=$this->lang->line('Please login into your account')?> <a href='<?=site_url()?>'>link</a> <?=site_url()?>
                                <br><br>
