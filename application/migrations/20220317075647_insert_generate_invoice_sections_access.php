...
class Migration_insert_generate_invoice_sections_access extends CI_Migration {
        ...
        public function down()
        {
                $sql = 'DELETE FROM users_sections_access WHERE user_section_access_user_type = 2 
                                        ...
                                        and user_section_access_method_name = "generateInvoice";
