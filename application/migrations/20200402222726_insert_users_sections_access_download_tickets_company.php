...
class Migration_insert_users_sections_access_download_tickets_company extends CI_Migration {
        ...
        public function down()
        {
                $sql = 'DELETE FROM users_sections_access WHERE user_section_access_user_type = 2 
                        ...
                        and user_section_access_method_name = "downloadTickets";
