...
class Migration_insert_company_details_sections_access_table extends CI_Migration {
        ...
        public function down()
        {
                $sql = '
                        ...
                        and user_section_access_method_name = "companyDetails";
                ';
                $this->db->query($sql); 
        }
